# -*- coding: utf-8 -*-
"""Data-Pipeline-Enhanced.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1pn6ILNN_9gZlgYMKVobidByRScBrQe0u
"""
...
#     parser.add_argument("--input_file", type=str, required=True, help="Path to PDF/TXT policy file.")
#     parser.add_argument("--out", type=str, default="bank_qa_dataset_phi3.json", help="Output JSON filename.")
#     args = parser.parse_args()

#     assert os.path.exists(args.input_file), "Input file not found."

#     run_pipeline(args.input_file, args.out)
...
# !python3 /content/Data-Pipeline-colab-local-enhanced.ipynb --input_file "amanah_bank_policy.pdf" --out "results.json"
