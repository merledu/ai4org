...
def check_environment_variables():
    ...
    if env_file.exists():
        ...
        print_check(False, ".env file NOT found (using defaults)")
...
def check_model_cache():
    ...
    if cache_dir.exists():
        ...
        print_check(
            True, f"HuggingFace cache exists: {len(cached_models)} models cached"
        )
        ...
        print_check(
            False,
            "HuggingFace cache not found (models will be downloaded on first run)",
        )
