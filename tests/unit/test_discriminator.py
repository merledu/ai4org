...
class TestLoadDiscriminator:
    ...
    @patch(
        "hallucination_reduction.discriminator.AutoModelForSequenceClassification.from_pretrained"
    )
    ...
    def test_uses_default_model_name(self, mock_tokenizer, mock_model):
        ...
        from hallucination_reduction.discriminator import DISC_MODEL, load_discriminator
...
class TestDiscriminatorPredictText:
    ...
    def mock_classifier(self):
        ...
        def mock_forward(**kwargs):
            ...
            mock_output.logits = torch.randn(
                batch_size, 2
            )  # Dynamic batch_size, num_classes=2
            return mock_output
    ...
    def test_tokenizer_uses_padding_and_truncation(
        self, mock_classifier, mock_tokenizer
    ):
    ...
    def test_batch_size_parameter(self, mock_classifier, mock_tokenizer):
        ...
        result = discriminator_predict_text(
            mock_classifier, mock_tokenizer, texts, batch_size=batch_size
        )
...
class TestSimpleTextDataset:
    ...
    def test_custom_max_length(self, mock_tokenizer, sample_data):
        ...
        dataset = SimpleTextDataset(
            texts, labels, mock_tokenizer, max_length=custom_max_length
        )
