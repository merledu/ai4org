...
class TestEvaluateClassifier:
    ...
    def test_evaluate_returns_dict(self, mock_classifier, mock_tokenizer, sample_eval_data):
        """Test that evaluate_classifier returns a dictionary."""
        from hallucination_reduction.discriminator_training_utils import evaluate_classifier
        
        texts, labels = sample_eval_data
        
        with patch('hallucination_reduction.discriminator_training_utils.discriminator_predict_text') as mock_predict:
    ...
    def test_evaluate_returns_all_metrics(self, mock_classifier, mock_tokenizer, sample_eval_data):
    ...
    def test_classifier_set_to_eval_mode(self, mock_classifier, mock_tokenizer, sample_eval_data):
    ...
    def test_accuracy_calculated_correctly(self, mock_classifier, mock_tokenizer, sample_eval_data):
        ...
        with patch('hallucination_reduction.discriminator_training_utils.discriminator_predict_text') as mock_predict:
            ...
            with patch('hallucination_reduction.discriminator_training_utils.accuracy_score') as mock_acc:
    ...
    def test_precision_recall_f1_calculated(self, mock_classifier, mock_tokenizer, sample_eval_data):
        ...
        with patch('hallucination_reduction.discriminator_training_utils.discriminator_predict_text') as mock_predict:
            ...
            with patch('hallucination_reduction.discriminator_training_utils.precision_recall_fscore_support') as mock_prf:
    ...
    def test_binary_average_used_for_metrics(self, mock_classifier, mock_tokenizer, sample_eval_data):
    ...
    def test_zero_division_handled(self, mock_classifier, mock_tokenizer, sample_eval_data):
    ...
    def test_metrics_are_numeric(self, mock_classifier, mock_tokenizer, sample_eval_data):
...
class TestTrainDiscriminatorMinibatchIntegration:
    ...
    def test_function_exists_and_callable(self):
        ...
        from hallucination_reduction.discriminator_training_utils import train_discriminator_minibatch
