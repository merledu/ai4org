...
from hallucination_reduction.main import main, unwrap
...
class TestMainFunction:
    ...
    @patch("hallucination_reduction.main.build_corpus_and_qa")
    @patch("torch.cuda.is_available")
    def test_cuda_device_selected_when_available(
        self,
        mock_cuda,
        mock_build,
        mock_retriever,
    ...
    @patch("hallucination_reduction.main.build_corpus_and_qa")
    @patch("torch.cuda.is_available")
    def test_trains_three_discriminators(
        self,
        mock_cuda,
        mock_build,
        mock_retriever,
    ...
    @patch("hallucination_reduction.main.build_corpus_and_qa")
    @patch("torch.cuda.is_available")
    def test_runs_reinforcement_learning(
        self,
        mock_cuda,
        mock_build,
        mock_retriever,
    ...
    @patch("hallucination_reduction.main.build_corpus_and_qa")
    @patch("torch.cuda.is_available")
    def test_evaluates_before_and_after_training(
        self,
        mock_cuda,
        mock_build,
        mock_retriever,
    ...
    @patch("hallucination_reduction.main.build_corpus_and_qa")
    @patch("torch.cuda.is_available")
    def test_creates_baseline_generator_copy(
        self,
        mock_cuda,
        mock_build,
        mock_retriever,
